        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <center><a href="{{$url}}" class="btn bg-cyan click-modal waves-effect" style="border-radius:2px; margin-right: 10px" target="black">Send to WhatsApp</a><a href="{{route('cashier.index')}}" class="btn bg-amber click-modal waves-effect" style="border-radius:2px;" target="black">Finish</a></center>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"></div>
